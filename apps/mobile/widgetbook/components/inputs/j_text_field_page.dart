  ...
  return WidgetbookComponent(
    ...
    useCases: [
      ...
      WidgetbookUseCase(
        ...
        builder: (ctx) => _frame(JTextField(
          label: 'Email',
          controller: TextEditingController(text: 'aria.tasker123@example.com'),
        )),
      ),
      WidgetbookUseCase(
      ...
      WidgetbookUseCase(
        ...
        builder: (ctx) => _frame(Column(
          ...
          children: [
            ...
            JButton.primary(label: 'Sign up', onPressed: () {}, expanded: true),
          ],
        )),
      ),
    ],
