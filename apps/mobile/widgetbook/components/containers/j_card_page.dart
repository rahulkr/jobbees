        ...
        builder: (ctx) => _frame(
          JCard(
            child: Column(
              ...
              children: const [
                Text(
                  'Fence repair — Newtown',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),
                ),
                SizedBox(height: JSpacing.xs),
                Text(
                  'Three damaged panels, need replacement.',
                  style: TextStyle(fontSize: 14),
                ),
                SizedBox(height: JSpacing.sm),
                Text(
                  '\$180 budget · 2.1 km away',
          ...
          JCard.elevated(
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: JSpacing.xs),
                Text(
                  '\$84 will release when work is complete',
                  style: TextStyle(fontSize: 14),
                ),
              ],
            ),
...
Widget _frame(Widget child) =>
    Padding(padding: const EdgeInsets.all(JSpacing.base), child: child);
