    ...
    useCases: [
      ...
      WidgetbookUseCase(
        ...
        builder: (ctx) => JEmptyState(
          ...
          title: 'No offers yet',
          body: 'Most jobs get their first offer within 2 hours. You can edit the job while you wait.',
          primaryAction: JButton.primary(
            label: 'Edit job',
            onPressed: () {},
          ),
      ...
      WidgetbookUseCase(
        ...
        builder: (ctx) => JEmptyState(
          ...
          body: 'Get verified once with Stripe, then offer on any job. Takes 5 minutes.',
          primaryAction: JButton.primary(
      ...
      WidgetbookUseCase(
        ...
        builder: (ctx) => const JEmptyState(
          ...
          body: 'When you have an accepted offer, your conversations with the client or tasker will live here.',
        ),
      ),
      WidgetbookUseCase(
        ...
        builder: (ctx) => const JEmptyState(
          ...
          title: 'All caught up',
          body: "We'll let you know about new offers, accepted bids, and messages.",
        ),
      ),
    ],
  );
