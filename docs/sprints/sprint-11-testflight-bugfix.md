...
By Friday 13 Nov, the client installs JOBBees on their iPhone via TestFlight + on an Android phone via Play Store internal track, runs the entire happy path (signup → KYC → post task → bid → accept → message → pay → complete → review → tax invoice), reports bugs, you fix them.
...
| --- | -------------------------------------------------------------- | ---- | --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 70  | Re-post / clone task                                           | THIN | 1   |                                                                                                                                                              |
| 84  | Task search bar — polish                                       | THIN | 1   |                                                                                                                                                              |
...
| 212 | Offline draft persistence (tasks only)                         | THIN | 3   |                                                                                                                                                              |
...
| 528 | **Contextual tooltips on first use (5-6 key moments)**         | IN   | 5   | New: first-time-only tooltips on bid placement, accept bid, held funds, completion proof, AI-matched badge. Track "seen" via local storage. Auto-dismiss 4s. |
| 529 | **"How it works" static help page**                            | IN   | 2   | New: single screen explaining post / bid / payment / become-tasker. Linked from empty states + Help menu.                                                    |
...
| 517 | Task detail public page (SEO-indexed) | THIN | 5   |                       |
...
01:30 — Client posts a real task (e.g., "Assemble a desk Saturday").
01:50 — Switch to second device (Android) — tasker bids.
02:10 — Client (poster) accepts the bid on iPhone.
...
| Wed 11 (D8)  | Public web landing + task detail public page + sitemap + OG cards.                                    | Bug-fix.                                                               |
...
- [ ] 5 SEO web rows complete (landing + public task + sitemap + OG)
...
- `feat(web): landing page + public task page + sitemap + OG cards`
