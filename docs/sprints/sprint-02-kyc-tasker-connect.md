...
| ID    | Item                                                                                                                    | Call | Hrs | Notes                                                                                                                                                                                           |
| ----- | ----------------------------------------------------------------------------------------------------------------------- | ---- | --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FW-04 | **Web parity — welcome carousel, signup, OAuth, login, biometric fallback, OTP, role select, suspended/banned screens** | IN   | 6   | Responsive breakpoints (mobile / tablet / desktop), web-safe biometric fallback (WebAuthn passkey where available, else password-only with link-via-email), OAuth via redirect flow vs popover. |
