...
**Dates:** Mon 5 Oct → Fri 16 Oct 2026 (10 working days)
**Theme:** The full admin Next.js console — KYC review, dispute mediation, refund processing, content moderation, FAQ + categories CRUD, payment + tax tooling, configuration.
**Hours budget:** ~85 (75 admin, 10 backend tweaks)
**Mid-sprint demo:** Fri 9 Oct
**End-of-sprint demo:** Fri 16 Oct
...
00:55 — KYC review: open one. View ID document + selfie + ABN.
        Approve. Notification fires to user. Status updates everywhere.
...
| Wed 7 (D3) | User list + detail. KYC review queue (full UI). Connect tracker. | Suspend/ban + reinstate endpoints. |
...
- `feat(admin/users): list + detail + KYC review + Connect tracker`
