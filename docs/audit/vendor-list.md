...
| **Google (Gemini API)**     | LLM (job extraction, dispute mediation co-input, support RAG)                                                   | ✅ Locked                | Redacted user content                         | US/global                                     | [Google DPA](https://cloud.google.com/terms/data-processing-addendum) — zero-retention enabled on API                                                                                  |
...
| **OpenAI (Embeddings API)** | Vector embeddings (text-embedding-3-small, 1536 dims)                                                           | ✅ Locked                | Job title + description + tasker bio (no PII) | US                                            | [OpenAI DPA](https://openai.com/policies/data-processing-addendum) — zero-retention on API tier                                                                                        |
