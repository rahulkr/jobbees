...
| Job                    | 2 years from `completedAt` or `cancelledAt`          | Quarterly cron  | Hard delete                                     |
| Offer                  | Cascade with Job                                     | —               | Cascade                                         |
| Review                 | Anonymise on user delete; 2 years for the linked job | Cascade         | Anonymise reviewer name to "Former member"      |
...
6. Cascade delete: Offers, Threads/Messages, Disputes (anonymised)
